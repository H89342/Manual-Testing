...
1. Ask the user to provide the test cases to review (paste or reference the file from `.claude/workflows/03-test-cases/`).
...
4. Save review report to: `.claude/workflows/03-test-cases/review-[feature-name].md`
